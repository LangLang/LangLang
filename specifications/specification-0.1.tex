...
\]
\emph{TODO: This rule has an internal context which needs to be dropped once the subexpression has been evaluated.}


\[
\infer{\vdash \bot}{(\vdash \mathtt{t}_0).exs_1} \eqno{3.4.1}
\]

\[
\infer{\dfrac{\left(\dfrac{(\vdash \lambda \rightarrow c).(\mathtt{t}_0 \rightarrow \top)}{\vdots}\right).exs_1}{\vdots}}{(c \vdash \mathtt{t}_0).exs_1} \eqno{3.4.2}
\]
...
{cs,c \vdash \mathtt{t}_0.exs_1} \eqno{3.4.3}
\]
