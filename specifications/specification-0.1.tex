...
{(\vdash \mathtt{t}_0).exs_1} \eqno{3.1.4.1}
\]

\[
\infer{\dfrac{\lambda \rightarrow \left(\dfrac{\left(\vdash (\lambda \rightarrow  c).\mathtt{t}_0\right).\top}{\vdots}\right).\left(\dfrac{c \vdash exs_1}{\vdots}\right)}{\vdots}}
{(c \vdash \mathtt{t}_0).exs_1} \eqno{3.1.4.2}
\]
...
{(cs,c \vdash \mathtt{t}_0).exs_1} \eqno{3.1.4.3}
\]
