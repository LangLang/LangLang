...
This is because once $\top$ will be absorbed into the context of its codomain -- this will become more clear taking into account the rules that deal with context.
