...
When a symbol is written, it includes context. Hence,

\[
\infer{d \rightarrow e \vdash a \rightarrow (b\ c)}{a \rightarrow b, a \rightarrow c, d \rightarrow e \vdash a}
\]

Thus when a query is done it evaluates the least nested arrow,
...
\[
\infer{\dfrac{(a \rightarrow b) \rightarrow c \vdash ((a \rightarrow b) \rightarrow c).b}{(a \rightarrow b) \rightarrow c \vdash \bot}}{(a \rightarrow b) \rightarrow c \vdash (a \rightarrow b).b}
\]

Thus rules like this are not correct
