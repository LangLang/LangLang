...
This is not explicitly handled by the operational semantics as we're 
Recall from the denotational semantics that
\[
(ctx_0 \vdash ex_0\ ctx_1 \vdash ex_1\ \vdash \bot \ ctx_3 \vdash ex_3) \triangleq (ctx_0 \vdash ex_0\ ctx_1 \vdash ex_1\ ctx_3 \vdash ex_3)
\]
and
\[
(\vdash \bot\ \vdash \bot) \triangleq\ \vdash \bot
\]
