...
This allows LangLang to use a similar scoping mechanism to conventional programming languages where declarations inside the same scope are dependent on each other.
...
Furthermore, since expressions inside the collection may depend on other expressions in the collection, the order in which expressions are evaluated may vary.
