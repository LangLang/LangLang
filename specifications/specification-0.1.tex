...
{ctx \vdash (exs_{0_0}.exs_{0_1}).exs_1} \eqno{3.1}
\]

\[
\infer{\dfrac{ctx \vdash exs_0.\left(\dfrac{ctx \vdash exs_{1_0}.exs_{1_1}}{\vdots}\right)}{\vdots}}
{ctx \vdash exs_0.(exs_{1_0}.exs_{1_1})} \eqno{3.2}
\]

\[
\infer{ctx \vdash \mathtt{t_a}}{ctx \vdash (\lambda \rightarrow \mathtt{t_a}).\mathtt{t_a}} \eqno{3.3}
\]

\[
\infer{ctx_0 \vdash \mathtt{t_a}}{(\lambda \rightarrow (ctx_0 \vdash \mathtt{t_a})).(ctx_1 \vdash \mathtt{t_a})} \eqno{3.4}
\]
